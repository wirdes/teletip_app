...
import 'package:teletip_app/pages/login/or_divider.dart';
    ...
    return SingleChildScrollView(
      ...
      children: [
        ...
        FormHelper.inputFieldWidget(
            context, const Icon(Icons.person), "name", "Adınız",
            (onValidateVal) {
        ...
        Padding(
          ...
          child: FormHelper.inputFieldWidget(
              context, const Icon(Icons.person), "surname", "Soyadınız",
              (onValidateVal) {
            if (onValidateVal.isEmpty) {
        ...
        Padding(
          padding: const EdgeInsets.only(top: 10),
          child: FormHelper.inputFieldWidget(
              context, const Icon(Icons.email), "email", "E-mail",
              (onValidateVal) {
            if (onValidateVal.isEmpty) {
        ...
        Padding(
          padding: const EdgeInsets.only(top: 10),
          child: FormHelper.inputFieldWidget(
              context, const Icon(Icons.lock), "password", "Şifre",
              (onValidateVal) {
